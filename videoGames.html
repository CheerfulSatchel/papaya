...
$.ajax({
    ...
    success: function (response) {
        ...
        $.each(response, function (i, val) {
            trHTML += "<tr><td>" + val.title + "</td><td>" + val.platform + "</td><td>" + val.genre + "</td><td>" + val.price +
            "</td><td> <button type='button' class='btn-md' onClick=\"(buyGame('" + val.item_id + "," + email + "'))\">Add To Cart</button></td>";
...
<title>Video Games Section</title>
</head>
